...
var Checkbox = exports.Checkbox = (_dec = (0, _dependencies.dependencies)('$scope', '$element'), (_class = function () {
    ...
    _createClass(Checkbox, [{
        ...
        value: function controller(scope, $element) {
            ...
            this.input.checked = !!((_context = this.rootDOM, _utils.props).call(_context, 'checked') || false);
        ...
        value: function link(scope, $elem, attrs, ctrl) {
            ...
            (_context2 = this.input, _utils.on).call(_context2, 'change', function () {
                for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
                    args[_key] = arguments[_key];
                }

                _this2.handle.apply(_this2, args);
