...
var Pagination = (_dec = (0, _dependencies.dependencies)('$scope'), (_class = function () {
    function Pagination() {
    ...
    _createClass(Pagination, [{
        ...
        value: function compile($tElement, tAttrs, transclude) {
            var elem = $tElement[0];
            this.prevLabel = _utils.query.call(elem, '.fm-pagination-prev');
            this.nextLabal = _utils.query.call(elem, '.fm-pagination-next');
            this.hasJumper = _utils.props.call(elem, 'jumper');
            if (this.hasJumper) {
                var jumper = '<div class="fm-pagination-jumper">\n                <span>跳至</span>\n                <input class="fm-pagination-jumper-input" />\n                <span>页</span>\n            </div>';
                _utils.last.call(elem, jumper);
            }
            return this.link;
        }
    }, {
        ...
        value: function controller(scope) {
            ...
            var _renderPages = function _renderPages() {
                ...
                scope.current === scope.last() ? (_context = _this.nextLabal, _utils.addClass).call(_context, 'hide') : (_context = _this.nextLabal, _utils.removeClass).call(_context, 'hide');
                scope.current === scope.first() ? (_context = _this.prevLabel, _utils.addClass).call(_context, 'hide') : (_context = _this.prevLabel, _utils.removeClass).call(_context, 'hide');
            };
        }
    }, {
        key: 'link',
