...
var unSupportDirection = 'Popover direction is not in announced list [top,bottom,left,right].';
var unSupportEvent = 'Event is not supported, it should one of the following values: [click, hover, focus, manual].';
