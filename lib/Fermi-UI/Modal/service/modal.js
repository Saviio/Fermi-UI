...
var Modal = (_dec = (0, _dependencies.dependencies)('$compile', '$controller', '$rootScope'), _dec(_class = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function open(options) {
            ...
            if ((_context2 = options.controller, _utils.getType).call(_context2) === 'String' || (_context2 = options.controller, _utils.getType).call(_context2) === 'Array') {
                var _context3;

                var alias = (_context3 = options.controllerAs, _utils.getType).call(_context3) === 'String' ? options.controllerAs : null;

                var controller = controllerGetter(options.controller, {
                    $scope: modalScope,
                    $element: $template
                }, false, alias);
