...
var FermiDefaultDirective = (_dec = (0, _dependencies.dependencies)('$scope', '$attrs', '$parse'), (_class = function () {
    function FermiDefaultDirective() {
        _classCallCheck(this, FermiDefaultDirective);

        this.restrict = 'A';
        this.require = '^ngModel';
    }

    _createClass(FermiDefaultDirective, [{
        key: 'controller',
        value: function controller($scope, $attrs, $parse) {
...
exports.default = FermiDefaultDirective;